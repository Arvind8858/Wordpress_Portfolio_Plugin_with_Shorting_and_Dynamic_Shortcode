...
$result_page = $wpdb->get_results("SELECT * FROM ".$wpdb->prefix."posts WHERE post_status = 'publish' and comment_status = 'open' and ( post_title like '%".$text."%' or post_content like '%".$text."%' or post_type like '%".$text."%');");
$total_results = $wpdb->num_rows;
$total_pages = ceil($total_results / $max_results);
$results = $wpdb->get_results("SELECT * FROM ".$wpdb->prefix."posts WHERE post_status = 'publish' and comment_status = 'open' and ( post_title like '%".$text."%' or post_content like '%".$text."%' or post_type like '%".$text."%') LIMIT $from, $max_results;");
